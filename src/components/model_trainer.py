...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            model_report(y_pred=y_pred, y_test=y_test,file_path=self.model_trainer_config.model_report_path,output="artifacts/output/confusion_matrix_credit_risk.png")
